...
public class Armstrong {
    ...
    public static void main(String[] args) {
        ...
        int c = 12;
        int d = 1234567;
        System.out.println("arm(135, numLen(135)) = " + (long) arm(a, digitCounter(a)));
        System.out.println("arm(370, numLen(370)) = " + (long) arm(b, digitCounter(b)));
        System.out.println("arm(12, numLen(12)) = " + (long) arm(c, digitCounter(c)));
