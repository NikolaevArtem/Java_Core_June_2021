...
public class RandomCharsTable implements Runnable {
    ...
    public void run() {
     ...
     void printOddCapitalLetters(char[][] table) {
     ...
     void printEvenCapitalLetters(char[][] charsTable) {
     ...
     void printCapitalLetters(char[][] charsTable, String strategy) {
     ...
     void printTable(char[][] charsTable) {
        for (char[] line : charsTable) {
            System.out.print("| ");
            for (char column : line) {
     ...
     void solveTask(String consoleString) {
