...
public class OldPyramidPrinter {
    ...
    public static void main(String[] args) {
        int base = getBase();
        String result = calculate(base);
        ResultPrinter rp = new ResultPrinter();

        rp.printResult(result, Integer.toString(base), OUTPUT_STREAM);
    }

    private static String calculate(int baseOfPyramid) {
