...
class ExtraPyramidPrinterTest extends UnitBase {
    ...
    @Test
    void given_1_whenRun_then_printInvertPyramid() {
        setInput("1");

        new ExtraPyramidPrinter().run("invert");
    ...
    @Test
    void given_3_whenRun_then_printInvertPyramid() {
        setInput("3");
        ...
        assertEquals("xxx", getOutputLines()[0]);
        assertEquals("xx", getOutputLines()[1]);
        assertEquals("x", getOutputLines()[2]);
    }
