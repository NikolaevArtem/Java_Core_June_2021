...
public class ManualShipPlacerTest extends UnitBase {
    ...
    void givenShipPlacer_whenShipsPlace_thenNewShipPlacerPlaceShips() {
        ...
        getOutput();
        assertEquals("\u001B[32m   A B C D E F G H I J", getOutputLines()[getOutputLines().length - 12]);
        assertEquals(" 1 O ~ O ~ ~ O ~ ~ O O", getOutputLines()[getOutputLines().length - 11]);
        assertEquals(" 2 ~ ~ O ~ ~ O ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 10]);
        assertEquals(" 3 O ~ ~ ~ ~ O ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 9]);
        assertEquals(" 4 ~ ~ ~ ~ ~ O ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 8]);
        assertEquals(" 5 O ~ ~ ~ ~ ~ ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 7]);
        assertEquals(" 6 ~ ~ O ~ ~ ~ ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 6]);
        assertEquals(" 7 O ~ O ~ ~ ~ ~ O O O", getOutputLines()[getOutputLines().length - 5]);
        assertEquals(" 8 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 4]);
        assertEquals(" 9 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 3]);
        assertEquals("10 ~ ~ ~ ~ ~ ~ ~ O O O", getOutputLines()[getOutputLines().length - 2]);
    }
    ...
    void givenShipPlacerAndSomeWrongInput_whenShipsPlace_thenPrintWarnings() {
        ...
        assertEquals(invalidInputWarning, getOutputLines()[getOutputLines().length - 14]);
        assertEquals("\u001B[32m   A B C D E F G H I J", getOutputLines()[getOutputLines().length - 12]);
        assertEquals(" 1 O ~ O ~ ~ O ~ ~ O O", getOutputLines()[getOutputLines().length - 11]);
        assertEquals(" 2 ~ ~ O ~ ~ O ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 10]);
        assertEquals(" 3 O ~ ~ ~ ~ O ~ ~ ~ ~", getOutputLines()[getOutputLines().length - 9]);
